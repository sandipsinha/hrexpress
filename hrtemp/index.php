...
if ($_SERVER ['AUTHENTICATE_EMPLOYEETYPE'] > ' '){
...
<body id="main_body" > <img src='/images/logo.png'/ alt=”Logo” width="190" height="100">
...
<br><br>
<li>
<a href="http://hrexpress.polycom.com/srccd/dbrtn/read_ee.php" style="text-decoration:none">Change Request</a>
</li>
<br>
<br>
<li>
<a href="http://hrexpress.polycom.com/srccd/dbrtn/pick_ee.php" style="text-decoration:none">AdHoc Mail</a>
</li>
<br>
<br>
<li>
<a href="http://hrexpress.polycom.com/srccd/dbrtn/eegrid.php" style="text-decoration:none">Reports</a>
</li>
<br>
<br>
<li>
<a href="http://hrexpress.polycom.com/srccd/dbrtn/read_vndr.php" style="text-decoration:none">Manage Vendors</a>
</li>
<br>
<br>
<li id='flupld'>
...
session_start();
 if (isset($_SESSION['id']))
   ...
   ?>
		...
		<p>
			<?php echo 'Hello '. $name_arr[1].'. Listed below are your job details. Please review and let your HR Rep know if any of them are outdated or not showing the right information'; 
                     ?>
		</p> 
